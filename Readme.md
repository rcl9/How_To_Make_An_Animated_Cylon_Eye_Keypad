...
This repository explains how I created the custom numeric keypad for my
<a href="https://github.com/rcl9/Phoenix_MIDI_Computer">Phoenix (Z80) MIDI Processor Computer</a>
and how the animated "Cylon Eye" (inspired from Battlestar Galatica) was implemented in hardware + Z80 assembly code.

<div style="text-align:center">
<img src="/Images/Animated_CylonEye_500.gif" alt="" style="width:100%; height:auto;">
</div>

This is the Phoenix MIDI processor computer, its two main component boards, LCD display and keypad plus
